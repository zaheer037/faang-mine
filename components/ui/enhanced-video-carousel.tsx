...
import { EnhancedPortraitVideo } from "./enhanced-portrait-video"
...
export function EnhancedVideoCarousel({ videos, className = "", speed = 50 }: EnhancedVideoCarouselProps) {
      ...
      <div className="flex justify-center mt-4 space-x-2">
        {!isHovered && !isPaused && (
          <div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <span>Auto-scrolling • Hover to pause • Click video for portrait fullscreen</span>
          </div>
        )}
        {(isHovered || isPaused) && (
          <div className="flex items-center space-x-2 text-sm text-gray-700">
            <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
            <span>Paused • Click video for portrait fullscreen with audio</span>
          </div>
        )}
      </div>
    </div>
